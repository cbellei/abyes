...
exp1 = abyes.AbExp(alpha=0.95, method='analytic', rule='rope', plot=True)
...
exp2 = abyes.AbExp(alpha=0.95, method='analytic', rule='loss', plot=True)
...
exp3 = abyes.AbExp(alpha=0.95, method='mcmc', rule='rope', plot=True, resolution=1000)
data = [np.random.binomial(1, 0.5, size=10000), np.random.binomial(1, 0.5, size=10000)]
